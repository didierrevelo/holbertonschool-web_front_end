<h1 align="center"> 0x02. Advanced CSS <h1>
...
```
You can save it in a <code>index.html</code> file and replace the <code><.link rel='stylesheet' href='#'></code> by the right CSS file.
